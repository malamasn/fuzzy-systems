...
%dV
fis = addmf(fis, 'input', 1, 'S', 'trimf', [0 0 0.4]);
fis = addmf(fis, 'input', 1, 'M', 'trimf', [0.1 0.5 0.9]);
fis = addmf(fis, 'input', 1, 'L', 'trimf', [0.6 1 1]);
%dH
fis = addmf(fis, 'input', 2, 'S', 'trimf', [0 0 0.4]);
fis = addmf(fis, 'input', 2, 'M', 'trimf', [0.1 0.5 0.9]);
fis = addmf(fis, 'input', 2, 'L', 'trimf', [0.6 1 1]);
%theta
